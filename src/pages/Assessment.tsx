        ...
        <div className="container-custom max-w-[800px]">
          {!showResults ? (
                ...
                >
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          (questions[step].multi ? (answers[questions[step].id] || []).includes(opt.value) : answers[questions[step].id] === opt.value)
                            ...
                            : "border-gray-100 hover:border-[#6c5ce733] hover:bg-[#f8f9fa]"
                        )}
                      >
                        {opt.label}
                      </button>
                  ...
                  {questions[step].multi && (
                    <Button 
                      ...
                      className="w-full bg-[#6c5ce7] hover:bg-[#5b4cdb] text-white py-8 rounded-[16px] font-bold text-xl"
                    >
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-12">
              ...
              <div className="bg-[#f8f9fa] p-10 rounded-[30px] border border-gray-100">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button asChild className="flex-1 bg-[#6c5ce7] hover:bg-[#5b4cdb] text-white py-8 rounded-[16px] font-bold text-xl">
                  <Link to="/#contact">Book Free Consultation</Link>
                </Button>
                <Button variant="outline" className="flex-1 border-gray-100 py-8 rounded-[16px] font-bold text-xl" onClick={() => window.location.reload()}>
